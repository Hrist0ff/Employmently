...
namespace ServiceReference1
{
    ...
    public interface checkVatPortType
    {
        ...
        ServiceReference1.checkVatResponse checkVat(ServiceReference1.checkVatRequest request);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="", ReplyAction="*")]
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        ServiceReference1.checkVatApproxResponse checkVatApprox(ServiceReference1.checkVatApproxRequest request);
    ...
    public partial class checkVatPortTypeClient : System.ServiceModel.ClientBase<ServiceReference1.checkVatPortType>, ServiceReference1.checkVatPortType
    {
        ...
        ServiceReference1.checkVatResponse ServiceReference1.checkVatPortType.checkVat(ServiceReference1.checkVatRequest request)
        {
        ...
        {
            ServiceReference1.checkVatRequest inValue = new ServiceReference1.checkVatRequest();
            inValue.countryCode = countryCode;
            inValue.vatNumber = vatNumber;
            ServiceReference1.checkVatResponse retVal = ((ServiceReference1.checkVatPortType)(this)).checkVat(inValue);
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        ServiceReference1.checkVatApproxResponse ServiceReference1.checkVatPortType.checkVatApprox(ServiceReference1.checkVatApproxRequest request)
        {
        ...
        public System.DateTime checkVatApprox(
                    ...
                    out ServiceReference1.matchCode traderNameMatch, 
                    out ServiceReference1.matchCode traderCompanyTypeMatch, 
                    out ServiceReference1.matchCode traderStreetMatch, 
                    out ServiceReference1.matchCode traderPostcodeMatch, 
                    out ServiceReference1.matchCode traderCityMatch, 
                    out string requestIdentifier)
        {
            ServiceReference1.checkVatApproxRequest inValue = new ServiceReference1.checkVatApproxRequest();
            inValue.countryCode = countryCode;
            inValue.vatNumber = vatNumber;
            ...
            ServiceReference1.checkVatApproxResponse retVal = ((ServiceReference1.checkVatPortType)(this)).checkVatApprox(inValue);
            countryCode = retVal.countryCode;
            vatNumber = retVal.vatNumber;
            valid = retVal.valid;
